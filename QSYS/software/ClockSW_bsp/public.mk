...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../TimerSoC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x29080
SOPC_SYSID_FLAG += --sidp=0x29080
ELF_PATCH_FLAG  += --sidp 0x29080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1556784122
SOPC_SYSID_FLAG += --timestamp=1556784122
ELF_PATCH_FLAG  += --timestamp 1556784122
